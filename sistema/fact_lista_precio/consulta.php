...
$sql="SELECT round((count(*) /  ".$_POST["limite_reg"].".00 ) + ".$residuo.", 0) as total_paginas from fact.lista_precio 
		 ...
		 <table class="table" >
			<thead>
				<tr>
					<th>Codigo</th>
					<th>NOMBRE </th>
					<th <?php echo  $oculta_size; ?> >MARGEN</th>
                    <th <?php echo  $oculta_size; ?> >EN USO</th>
					<th>Editar</th>
				</tr>
			</thead>
			<tbody>
					<?php 
						$sql="select * from fact.lista_precio where  cuenta='".get_sesion("id_cuenta")."' and 
						...
						<tr>
							...
							<td <?php echo  $oculta_size; ?> ><?php echo   $fila["margen"]; ?></td>
                            <td <?php echo  $oculta_size; ?> ><?php echo   $fila["en_uso"]; ?></td>
							<td>
