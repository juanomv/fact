...
$sql="UPDATE inv.operacion SET guia_remision='POR COBRAR' 
...
echo "
<script type=''>
	$('#guia_remision').val('POR COBRAR');
	MuestraDatos_contenido();
	mensaje('Proceso realizado correctamente<br>el pedido se encuentra por Cobrar.');
	CerrarForm();
</script>
";
?> 
