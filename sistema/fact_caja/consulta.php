...
///////////
$tipo_filtro="nombres,punto_emision";
...
$sql="SELECT round((count(*) /  ".$_POST["limite_reg"].".00 ) + ".$residuo.", 0) as total_paginas from fact.caja 
where sucursal='".get_sesion("sucursal")."' and cuenta='".get_sesion("id_cuenta")."' and empresa='".get_sesion("empresa")."' ".$filtro;
		 ...
		 <table class="table" >
			<thead>
				<tr>
					<th>Codigo</th>
					<th>NOMBRE </th>
					<th <?php echo  $oculta_size; ?> >PUNTO EMISION</th>
					<th>Editar</th>
				</tr>
			</thead>
			<tbody>
					<?php 
						$sql="select * from fact.caja where  sucursal='".get_sesion("sucursal")."' and cuenta='".get_sesion("id_cuenta")."' and 
						...
						<tr>
							...
							<td <?php echo  $oculta_size; ?> ><?php echo    $fila["punto_emision"]; ?></td>
							<td>
