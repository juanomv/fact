...
///////////
$tipo_filtro="nombre,direccion,email";
...
$sql="SELECT round((count(*) /  ".$_POST["limite_reg"].".00 ) + ".$residuo.", 0) as total_paginas FROM fact.cliente_proveedor
where cuenta='".get_sesion("id_cuenta")."' and  empresa='".get_sesion("empresa")."'  and tipo='CLI' ".$filtro;
...
<div class="card-body--">
	<div class="table-stats order-table ov-h" >
		 <table class="table" >
			...
			<tbody>
					<?php 
						$sql="SELECT * FROM fact.cliente_proveedor where cuenta='".get_sesion("id_cuenta")."' and  empresa='".get_sesion("empresa")."' and tipo='CLI' ".$filtro.
						...
						<tr>
							...
							<td <?php echo  $oculta_size; ?>><?php echo   $fila["email"]; ?></td>
							<td>
