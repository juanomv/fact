...
$sql="SELECT round((count(*) /  ".$_POST["limite_reg"].".00 ) + ".$residuo.", 0) as total_paginas from inv.categoria 
...
<div class="card-body--">
	<div class="table-stats order-table ov-h">
		 <table class="table" >
			...
			<tbody>
					<?php 
						$sql="select * from inv.categoria where  cuenta='".get_sesion("id_cuenta")."' and 
