...
///////////
$tipo_filtro="nombre,descripcion,codigo_barra";
...
$sql="SELECT round((count(*) /  ".$_POST["limite_reg"].".00 ) + ".$residuo.", 0) as total_paginas from inv.producto 
...
<div class="card-body--">
	<div class="table-stats order-table ov-h">
		 <table class="table" >
			...
			<tbody>
					<?php 
						$sql="select * from inv.producto where  cuenta='".get_sesion("id_cuenta")."' and 
						...
						<tr>
							...
							<td <?php echo  $oculta_size; ?> ><?php if($fila["tipo"]=='B'){ echo "BIEN";} else{ echo "SERVICIO";} ?></td>
                            <td <?php echo  $oculta_size; ?> ><?php echo  utf8_decode($fila["descripcion"]); ?></td>
                            <td <?php echo  $oculta_size; ?> ><?php if($fila["borrado"]=='N'){echo "ACTIVO";} else{echo "INACTIVO";} ?></td>
							<td>
